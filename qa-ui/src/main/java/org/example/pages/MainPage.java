...
public class MainPage extends Page {
    ...
    public MainPage open() {
        ...
        ensureOpen();
        LOGGER.info("Main page has been open");
        return this;
    }
    ...
    public class RegisterForm {
        ...
        public final TextField firstName = new TextField(driver, By.id("register-first-modal"), "User FirstName");
        public final TextField lastName = new TextField(driver, By.id("register-last-modal"), "User LastName");
        public final TextField email = new TextField(driver, By.id("register-email-modal"), "User email");
